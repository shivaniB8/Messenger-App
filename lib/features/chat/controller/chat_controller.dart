...
import 'package:chatapp_two/features/chat/repository/chat_repository.dart';
...
final groupMessagesStreamProvider =
    StreamProvider.family((ref, String groupId) {
...
class ChatController {
  ...
  void sendText({
    ...
    log("send text controller :>>: $text $receiverId $isGroup");
    ref.read(userFetchProvider).whenData((value) {
      log("whenData :>>: ${value.isSome()}");
      if (value.isSome()) {
