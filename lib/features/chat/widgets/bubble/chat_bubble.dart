...
import 'package:chatapp_two/features/chat/widgets/bubble/chat_bubble_bottom.dart';
import 'package:chatapp_two/features/chat/widgets/bubble/chat_reply_bubble.dart';
...
class ChatBubble extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final margin = isSenderMessage
        ? BubbleEdges.only(
            top: topMargin, left: 50, right: 10, bottom: bottomMargin)
        : BubbleEdges.only(
            top: topMargin, right: 50, left: 10, bottom: bottomMargin);
    final showNip = !repeatedSender;
    return SwipeTo(
      offsetDx: 0.16,
      onRightSwipe: (r) => makeReply(ref),
