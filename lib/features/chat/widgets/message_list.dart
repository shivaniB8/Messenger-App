...
import 'package:chatapp_two/features/chat/widgets/bubble/chat_bubble.dart';
import 'package:chatapp_two/features/chat/widgets/bubble/chat_image_bubble.dart';
import 'package:chatapp_two/features/chat/widgets/bubble/chat_time_bubble.dart';
import 'package:chatapp_two/features/chat/widgets/bubble/chat_audio_bubble.dart';
import 'package:chatapp_two/features/chat/widgets/bubble/chat_video_bubble.dart';
      ...
      data: (messages) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final repeatedSender =
                index > 0 && messages[index - 1].senderId == message.senderId;
            final isMyMessage = message.senderId == userId;
            final sentAt = message.timeSent;
            final shouldRenderTime = index == 0 ||
                sentAt.difference(messages[index - 1].timeSent).inDays > 0;
