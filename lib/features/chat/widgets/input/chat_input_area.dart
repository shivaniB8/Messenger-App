...
import 'package:chatapp_two/features/chat/widgets/input/chat_input_card.dart';
import 'package:chatapp_two/features/chat/widgets/input/chat_keyboard.dart';
...
class _ChatInputAreaState extends ConsumerState<ChatInputArea> {
  ...
  void sendText() async {
    if (!isTyping) {
      ...
      log("sendText :>>: ${_inputController.text}");
      // user is typing
